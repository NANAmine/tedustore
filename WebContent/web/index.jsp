...
<div class="ck-slide">
    <ul class="ck-slide-wrapper">
        <li>
            <a href="${pageContext.request.contextPath}/goods/showGoodsInfo.do?goodsId=9&categoryId=163"><img src="${pageContext.request.contextPath}/images/itemCat/itemCat_banner1.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="${pageContext.request.contextPath}/goods/showGoodsInfo.do?goodsId=58&categoryId=238"><img src="${pageContext.request.contextPath}/images/itemCat/itemCat_banner2.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="${pageContext.request.contextPath}/goods/showGoodsInfo.do?goodsId=21&categoryId=163"><img src="${pageContext.request.contextPath}/images/itemCat/itemCat_banner3.png" alt=""></a>
        </li>
        <li style="display:none">
            <a href="${pageContext.request.contextPath}/goods/showGoodsInfo.do?goodsId=59&categoryId=238"><img src="${pageContext.request.contextPath}/images/itemCat/itemCat_banner4.png" alt=""></a>
        </li>
        <li>
            <a href="${pageContext.request.contextPath}/goods/showGoodsInfo.do?goodsId=33&categoryId=163"><img src="${pageContext.request.contextPath}/images/itemCat/itemCat_banner1.png" alt=""></a>
        </li>
    </ul>
...
function itemInfo(id,categoryId){
	...
	location="${pageContext.request.contextPath}/goods/showGoodsInfo.do?goodsId="+id+"&categoryId="+categoryId;
}
