	                ...
	                <div class="imfor">
	                    ...
	                    <div class="pudc">
	                        ...
	                        <span class="des lf">
	                            ...
	                            <p class="col lf"><span>规格：</span><span class="color_des">${cartVo.spec}<input type="hidden" name="" value=""></span></p>
	                        </div>
	                    </div>
	                    <div class="pices">
	                    ...
	                    <input
	                    	 type="text" value="${cartVo.count }" 
	                    style="width:40px;text-align:center"><span class="add">&nbsp;+&nbsp;</span></div>
	                    <div class="totle">
	                        <span>￥</span>
	                        <span class="totle_information">${cartVo.count*cartVo.price }</span>
	                    </div>
	                    <div class="del">
	                        <!-- <div>
